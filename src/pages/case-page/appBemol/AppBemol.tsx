            ...
            <Chapter id='chapter-2-1'>
                ...
                <ContentBlock>
                    ...
                    <div className="subsection-img__wrapper">
                        <img src={desingSystemImg} alt="design sistem" style={{ width: '100%' }} />
                    </div>
                </ContentBlock>
                ...
                <ContentBlock>
                    <ContentWrapper title="PLANO DE ACOMPANHAMENTO">
                        ...
                        <ul className="content-list">
                            <li><span>Taxa de adesão</span> à Conta Bemol</li>
                            <li><span>Conversão</span> no fluxo de contratação</li>
            ...
            <Chapter id='chapter-2-2'>
                ...
                <ContentBlock>
                    <ContentWrapper title="DIAGNÓSTICO">
                        ...
                        <ul className="content-list">
                            <li><span>Experiência fragmentada</span> e pouco intuitiva</li>
                            <li><span>Falta de clareza</span> na exibição das informações (impactando a confiança do usuário)</li>
