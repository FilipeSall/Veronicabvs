...
import phone7 from "../../../../../assets/melliuz/phone7.webp";
      ...
      <div className={styles.mainWrapper}>
        <div className={styles.container}>
          ...
          <div className={styles.stepWrapper}>
            ...
            <p>
              Escolhe uma Ong parceira, de sua preferência, para receber a
              doação
            </p>
          </div>
          <div className={styles.stepWrapper}>
        ...
        <div className={styles.secondContainer}>
          ...
          <div className={styles.mainStepContainer}>
            ...
            <div className={styles.textWrapper}>
              ...
              <p>
                Compartilha arte pronta em sua rede social, de forma prática e
                rápida
              </p>
            </div>
          </div>
