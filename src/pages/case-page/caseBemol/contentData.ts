...
export const processDataApp = [
  ...
  {
    title: "Discovery",
    lists: ["Benchmarking", "Discussões exploratórias com áreas parceiras"],
  },
  {
    title: "Define",
    lists: ["Solução", "Alinhamento com as áreas envolvidas"],
  },
  {
    title: "Develop",
    lists: ["Design System", "Co-criação (marketing)", "Prototipação em alta"],
  },
  {
    title: "Delivery",
    lists: ["Validação e apresentação", "Documentação", "Entrega"],
  },
  {
    title: "Follow-up",
