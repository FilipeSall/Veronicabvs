 ...
 */
function CaseTitleHeader({ id, title, subtitle, subtitleVariant = 'default', className }: CaseTitleHeaderProps) {
  return (
    <div className={`${styles.caseTitleWrapper} ${className || ""}`}>
      <div className={styles.titleTextContainer}>
        ...
        {subtitle && (
          <p className={`${styles.descriptionText} ${styles.strongWhite} ${
